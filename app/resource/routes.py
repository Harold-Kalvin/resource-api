...
def create_resource(resource: ResourceInput, db: Session = Depends(get_db)):
...
def read_resources(filters: ResourceFilters = Depends(), db: Session = Depends(get_db)):
...
def update_resource(resource_id: int, resource: ResourceInput, db: Session = Depends(get_db)):
